...
<div class="iqoniq_contant_wrapper">
    ...
    <div class="col-md-10">
        <input type="text" name="couponcode" id="couponcode" class="form-control" placeholder="Enter Coupon Code" 
               value="<?php echo isset($rsedit['couponcode']) ? $rsedit['couponcode'] : ''; ?>" 
               required pattern="\d{6}" title="Coupon code must be a 6-digit number">
        <span id="errcouponcode" class="errmsg flash"></span>
    </div>
</div><br>
...
<div class="row">
    ...
    <div class="col-md-10">
        <input type="date" name="expirydate" id="expirydate" class="form-control" 
               value="<?php echo isset($rsedit['expirydate']) ? $rsedit['expirydate'] : ''; ?>" required>
        <span id="errexpirydate" class="errmsg flash"></span>
    </div>
</div><br>
...
<div class="row">
    ...
    <div class="col-md-10">
        <input type="number" name="discount_percentage" id="discount_percentage" class="form-control" 
               ...
               value="<?php echo isset($rsedit['discount_percentage']) ? $rsedit['discount_percentage'] : ''; ?>" required>
        <span id="errdiscount_percentage" class="errmsg flash"></span>
    </div>
</div><br>
...
<div class="row">
    ...
    <div class="col-md-10">
        <input type="number" name="max_limit" id="max_limit" class="form-control" 
               placeholder="Enter Max Limit" min="0" 
               value="<?php echo isset($rsedit['max_limit']) ? $rsedit['max_limit'] : ''; ?>" required>
        <span id="errmax_limit" class="errmsg flash"></span>
    </div>
</div><br>
...
<div class="row">
    ...
    <div class="col-md-10">
        <textarea name="reason" id="reason" class="form-control" required><?php echo isset($rsedit['reason']) ? $rsedit['reason'] : ''; ?></textarea>
...
function validateForm() {
    ...
    const couponcodeRegex = /^\d{6}$/; // Regex for 6-digit number

    if (!couponcodeRegex.test(couponcode)) {
        document.getElementById("errcouponcode").innerText = "Coupon code must be a 6-digit number.";
        return false;
    } else {
        document.getElementById("errcouponcode").innerText = "";
    }

    // Other form fields validation (if any)
